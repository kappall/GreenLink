...
mixin _$PostModel {
 ...
 int? get id; String get description;@JsonKey(name: 'created_at') DateTime? get createdAt;@JsonKey(name: 'deleted_at') DateTime? get deletedAt; double get latitude; double get longitude; UserModel? get author; List<UserModel> get votes;@JsonKey(unknownEnumValue: PostCategory.unknown) PostCategory get category;
...
@useResult
$Res call({
 int? id, String description,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'deleted_at') DateTime? deletedAt, double latitude, double longitude, UserModel? author, List<UserModel> votes,@JsonKey(unknownEnumValue: PostCategory.unknown) PostCategory category
});
...
/// Create a copy of PostModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? description = null,Object? createdAt = freezed,Object? deletedAt = freezed,Object? latitude = null,Object? longitude = null,Object? author = freezed,Object? votes = null,Object? category = null,}) {
...
as List<UserModel>,category: null == category ? _self.category : category // ignore: cast_nullable_to_non_nullable
as PostCategory,
  ));
}
/// Create a copy of PostModel
...
class _PostModel extends PostModel {
  const _PostModel({this.id, required this.description, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'deleted_at') this.deletedAt, required this.latitude, required this.longitude, this.author, final  List<UserModel> votes = const <UserModel>[], @JsonKey(unknownEnumValue: PostCategory.unknown) required this.category}): _votes = votes,super._();
...
/// Create a copy of PostModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? description = null,Object? createdAt = freezed,Object? deletedAt = freezed,Object? latitude = null,Object? longitude = null,Object? author = freezed,Object? votes = null,Object? category = null,}) {
